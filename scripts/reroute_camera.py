...
class CameraRerouter:
	def __init__(self):
		self.image_sub = rospy.Subscriber('/cameras/right_hand_camera/image', sensor_msg.Image, self.img_handler)
		self.info_sub = rospy.Subscriber('/cameras/right_hand_camera/camera_info', sensor_msg.CameraInfo, self.info_handler)
